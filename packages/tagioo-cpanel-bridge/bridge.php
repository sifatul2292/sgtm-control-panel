...
function tagioo_discovery_report(array $config): array
{
    ...
    $detected = [
        'id' => tagioo_detect_column($columns, $configured('id'), ['order_number', 'order_no', 'invoice_no', 'order_id', 'id']),
...
function tagioo_schema(array $config): array
{
    ...
    $orderId = tagioo_pick_column($columns, $configured('id'), ['order_number', 'order_no', 'invoice_no', 'order_id', 'id'], true, 'order ID');
